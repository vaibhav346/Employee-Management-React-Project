...
export default function GetEmployee() {
  ...
  let fechemployees=()=>{
axios.get('http://localhost:8080/api/findall') // fetch all employees
      .then(response => {
              ...
              <div className="row g-0">
                ...
                <div className="col-8">
                  <div className="card-body p-2">
                    <p className="mb-1"><strong>ID:</strong> {employee.eid}</p>
                    <p className="mb-1"><strong>Dept:</strong> {employee.department}</p>
                    <p className="mb-1"><strong>Email:</strong> {employee.email}</p>
                    <p className="mb-1"><strong>Phone:</strong> {employee.contactno}</p>
                    <p className="mb-1"><strong>Salary:</strong> ₹{employee.salary.toLocaleString()}</p>
                    <p className="mb-1"><strong>Join Date:</strong> {employee.joiningdate}</p>
                    <p className="mb-1"><strong>DOB:</strong> {employee.dob}</p>
